...
CARD_VALUES = {'A': 94, 'K': 93, 'Q': 92, 'T': 90,
               '9': 89, '8': 88, '7': 87, '6': 86,
               '5': 85, '4': 84, '3': 83, '2': 82,
               'J': 81}
...
def first_rule(hand):
    ...
    if not card_counter:
        return 0  # All are jokers
    card_counter[max(card_counter, key=card_counter.get)] += jokers # Add jokers to best count

    match sorted(card_counter.values(), reverse=True):
        case [5]:
